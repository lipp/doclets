...
module.exports.getApiParams = function (doclet) {
  ...
  return {
    ...
    '_': _,
    tools: tools,
    versionsPath: '/' + [doclet.owner, doclet.repo].join('/'),
    articlesPath: '/' + [doclet.owner, doclet.repo, doclet.version].join('/') + '/',
    apiPath: '/' + [doclet.owner, doclet.repo, doclet.version].join('/') + '/g/'
  }
}
