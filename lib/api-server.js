...
var init = function (gitRoot) {
  ...
  var updateDoc = function (repository, branch, eventData) {
    ...
    data.repo.stars = eventData.repository.stargazers_count
    data.repo.user_image = eventData.sender && eventData.sender.avatar_url
    data.repo.description = eventData.repository.description
